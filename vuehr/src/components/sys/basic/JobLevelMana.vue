<template>
    <div>
        <div>
            ...
            <el-button icon="el-icon-plus" type="primary" size="small" style="margin-left: 5px" @click="addJobLevel">添加</el-button>
        </div>
            ...
            <div>
                <table>
                    <tr>
                        ...
                        <td><el-input style="margin-left: 5px" size="small" v-model="updateJl.name"></el-input></td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td><el-switch style="margin-left: 5px" v-model="updateJl.enabled" active-text="启用" inactive-text="禁用"></el-switch></td>
                    </tr>
                </table>
            </div>
