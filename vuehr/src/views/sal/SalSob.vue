    ...
    <div>
        ...
        <div style="margin-top: 10px">
            <el-table :data="salaries" border stripe>
                ...
                <el-table-column width="140" prop="name" label="账套名称"></el-table-column>
                ...
                <el-table-column width="90" prop="bonus" label="奖金"></el-table-column>
...
<script>
    export default {
        ...
        methods:{
            ...
            deleteSalary(data){
                this.$confirm('此操作将会删除【'+data.name+'】账套，是否继续？','提示',{
                    cancelButtonText:'取消',
